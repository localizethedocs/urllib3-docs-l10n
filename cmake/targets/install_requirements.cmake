...
if     (  ( VERSION MATCHES "^(main)$"        ) OR
    ...
    message(STATUS "Running 'uv pip install' command to install requirements with 'pylock.toml' file...")
    if (CMAKE_HOST_LINUX)
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E env
                ...
                --refresh # avoid matching previously cached urllib3
                --no-progress
                --verbose
        WORKING_DIRECTORY ${PROJ_OUT_REPO_DIR}
        ECHO_OUTPUT_VARIABLE
